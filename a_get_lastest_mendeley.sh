...
################################
### Log of mendeley versions
# mendeleydesktop-1.15-linux-x86_64
# mendeleydesktop-1.16-dev2-linux-x86_64
# mendeleydesktop-1.16.1-linux-x86_64
...
sed -i '10,11 s/^/#/' mendeley_launcher.desktop
